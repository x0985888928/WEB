    ...
    <div id="tab1" class="view">
      ...
      <form action="" method="post">
        <table>
          ...
          <tr>
            <td width="40%" >密碼</td>
            <td><input class="inputArea" name="pw" type="password" placeholder="更新密碼"></td>
          </tr>
          <tr>
            <td width="40%" >暱稱</td>
            <td><input class="inputArea" name = "nick" type="text" placeholder="">
							<?php
								if(isset($_SESSION['account'])){
									$ac=$_SESSION['account'];
									$link = mysqli_connect('localhost', 'project', '0931821282','traum');
          ...
          <tr>
            <td width="40%" >聯絡電話</td>
            <td><input name="phone" class="inputArea" type="text" value="<?php
							if(isset($_SESSION['account'])){
								$ac=$_SESSION['account'];
								$link = mysqli_connect('localhost', 'project', '0931821282','traum');
								mysqli_select_db($link, 'traum') or die("db");
    ...
    <div id="tab2" class="view">
      <div class="box">
        <div id="commemtTitle">
          ...
          <!-- <div class="point"> -->
            <div class="rateBox">
              <div class="howMuch" style = "width:10%"></div>
      ...
      <form action="" method="post">
        ...
        <div class="mediaBox">
          ...
          <Input Type="File" Name="YouFile">
				...
				<input class="enter" name ="int" type='submit' value='確認修改'>
      </form>
    </div>
